...
machines=("172.50.7.192" "172.50.12.28")


# SSH options for executing commands without prompting for password
ssh_options="-oBatchMode=yes -oStrictHostKeyChecking=no"

# Loop through each machine and get memory and CPU usage
